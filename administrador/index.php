...
<main class="app-content">
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                    ...
                    echo "<button type='submit' class='btn btn-danger btn-sm' name='expulsar'>Expulsar</button>";
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <a href="reportepdf.php" name="generarInforme" class="btn btn-primary">Reporte de Matriculados</a>
        </div>
    </div>
